...
namespace Pancake.Editor
{
    ...
    public class PopupEnterNameEditor : UIPopupEditor
    {
        ...
        private void DrawSetting()
        {
            ...
            _ipfEnterName.objectReferenceValue = EditorGUILayout.ObjectField(_ipfEnterName.objectReferenceValue, typeof(TMP_InputField), allowSceneObjects: true);
            EditorGUILayout.EndHorizontal();
            ...
            _txtCurrentCountryName.objectReferenceValue =
                EditorGUILayout.ObjectField(_txtCurrentCountryName.objectReferenceValue, typeof(TextMeshProUGUI), allowSceneObjects: true);
            EditorGUILayout.EndHorizontal();

            EditorGUILayout.BeginHorizontal();
            GUILayout.Label("Icon Country", GUILayout.Width(DEFAULT_LABEL_WIDTH));
            _imgCurrentCountryIcon.objectReferenceValue =
                EditorGUILayout.ObjectField(_imgCurrentCountryIcon.objectReferenceValue, typeof(Image), allowSceneObjects: true);
            EditorGUILayout.EndHorizontal();

            EditorGUILayout.BeginHorizontal();
            GUILayout.Label("Country Popup", GUILayout.Width(DEFAULT_LABEL_WIDTH));
            _selectCountryPopup.objectReferenceValue =
                EditorGUILayout.ObjectField(_selectCountryPopup.objectReferenceValue, typeof(RectTransform), allowSceneObjects: true);
            EditorGUILayout.EndHorizontal();
